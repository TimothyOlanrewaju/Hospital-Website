...
Route::get('/sop', [HomeController::class, 'sop'])->middleware('auth')->name('sop');
Route::get('/our_services',[HomeController::class,'our_services']);
Route::get('/view_procurement',[HomeController::class,'view_procurement']);
Route::get('/download/{file}', [HomeController::class, 'download']);
//displayInputFormAdmin
Route::get('/procurements',[AdminController::class,'procurements']);
//SubmitProcurementForm
Route::post('/upload_procurement',[AdminController::class,'upload_procurement']);


//showAllProcurements
Route::get('/show_procurement',[AdminController::class,'show_procurement']);
//DeleteProcurementById
Route::get('/delete_procurement/{id}',[AdminController::class,'delete_procurement']);


//Logout
Route::get('/log_out',[AdminController::class,'log_out']);

Route::get('/update_procurement/{id}',[AdminController::class,'update_procurement']);
Route::post('/edit_procurement/{id}',[AdminController::class,'edit_procurement']);
Route::get('/procurement_details/{id}',[HomeController::class,'procurement_details']);
