...
<div class="main-panel">
      ...
      @endif
<div class="row-md-12">
     <center><h2>Update Welcome</h2></center> 

        <form action="{{url('edit_welcome',$update_welcome->id)}}" method="POST" enctype="multipart/form-data">

         @csrf
            
               <div class="col-mb-6">
              <label for="exampleFormControlInput1" class="form-label"></label>
              <input type="text" name="title" class="form-control" id="exampleFormControlInput1" placeholder="enter a title" value="{{$update_welcome->title}}" required>
            </div>
            <div class="mb-3">
              <label for="exampleFormControlTextarea1" class="form-label"></label>
              <textarea class="form-control" name="message" id="exampleFormControlTextarea1" rows="3" required>{{$update_welcome->message}}</textarea>
            </div>
<div>
<h4>Old Image</h4>
<img src="/welcomeimage/{{$update_welcome->image}}">
</div><br><br>
            <div class="mb-3">
