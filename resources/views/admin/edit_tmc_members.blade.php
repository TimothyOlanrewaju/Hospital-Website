...
<div class="row-md-12">
  <center><h1 style="padding:30px; font-weight: bold;">UPDATE TMC MEMBER</h1></center>
       ...
       <form action="{{url('update_tmc',$post->id)}}" method="POST" enctype="multipart/form-data">

         @csrf
            
              <div class="col-mb-6">
              <label for="exampleFormControlInput1" class="form-label">Name</label>
              <input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="enter a Name" value="{{$post->name}}" required>
            </div><br><br>
            
            <div class="col-mb-6">
              <label for="exampleFormControlInput1" class="form-label">Designation</label>
              <input type="text" name="designation" class="form-control" id="exampleFormControlInput1" placeholder="enter a Designation" value="{{$post->designation}}" required>
            </div><br><br>
