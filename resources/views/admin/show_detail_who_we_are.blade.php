...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- partial -->
      <div class="container-fluid page-body-wrapper">
      	<div align="center" style="padding: 20px; width: 80%;">
  <table class="table-responsive"  class="table" class="table-bordered">
  <thead>
  ...
  <tbody>
   ...
   @foreach($detail_who_we_are as $post)
    <tr align="center" style="padding:20px;">
      <td>{{$post->banner_image}}</td>
      <td>{{$post->who_we_are_title}}</td>
      <td>{{$post->who_we_are_message}}</td>
      <td>{{$post->vision}}</td>
      <td>{{$post->mission}}</td>
      <td>{{$post->who_we_are_image}}</td>
      <td>{{$post->status}}</td>
      <td><a href="{{url('update_who_we',$post->id)}}" class="btn btn-primary">Update</a></td>


      <td>
      	<a class="btn btn-danger" href="{{url('delete_who',$post->id)}}" onclick="return confirm('Are You Sure to Delete This?')">Delete</a>
      </td>
    </tr>
    @endforeach
  </tbody>
