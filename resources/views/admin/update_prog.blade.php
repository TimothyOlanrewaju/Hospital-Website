...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      @endif
<div class="row-md-12">
  <center><h1 style="padding:30px; font-weight: bold;">UPDATE POST</h1></center>

        <form action="{{url('edit_prog',$update->id)}}" method="POST" enctype="multipart/form-data">

         @csrf
            
               <div class="col-mb-6">
              <label for="exampleFormControlInput1" class="form-label">Title</label>
              <input type="text" name="title" class="form-control" id="exampleFormControlInput1" placeholder="enter a title" value="{{$update->title}}" required>
            </div><br><br>
            <div class="mb-3">
              <label for="exampleFormControlTextarea1" class="form-label"> Message</label>
              <textarea class="form-control" name="message" id="exampleFormControlTextarea1" rows="3" required>{{$update->message}}</textarea>
            </div>

            <div class="" >
              <label >Old Image</label>
              <img src="/progimage/{{$update->image}}" height="150px" width="150px">
            </div>
