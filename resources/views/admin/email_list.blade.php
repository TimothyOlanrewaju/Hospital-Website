...
<body>
  ...
  <table class="table-responsive" align="center" class="table">
  <thead>
  ...
  <tbody>
  	@foreach($email_list as $appoints)
    <tr align="center" style="padding:20px;">
      <td>{{$appoints->id}}</td>
      <td>{{$appoints->email}}</td>
      <td>{{$appoints->status}}</td>
      <td>
      	<a class="btn btn-success" href="{{url('email_approved',$appoints->id)}}">approved</a>
      </td>

      <td>
      	<a class="btn btn-danger" href="{{url('email_cancel',$appoints->id)}}">Canceled</a>
      </td>


      <td>
        <a class="btn btn-danger" href="{{url('email_cancel',$appoints->id)}}" onclick="return confirm('Are You Sure to Delete This?')">Delete</a>
      </td>
    </tr>
    @endforeach
