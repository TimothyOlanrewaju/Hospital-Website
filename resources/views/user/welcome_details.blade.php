...
<section class="blog section" id="blog">
    <div class="container">
      ...
      @foreach ($welcome_details->last() ? [$welcome_details->last()] : [] as $welcome)

<div style="text-align:center;">
    <img style="padding: 20px; height:400px; width:550px; margin:auto;" src="/welcomeimage/{{$welcome->image}}" alt="#">
</div>
<div class="">
    <div class="">
        <h2><a href="blog-single.html">{{$welcome->title}}</a></h2>
        <p class="text">{{$welcome->message}}</p>
        <br>
    </div>
</div>
@endforeach
